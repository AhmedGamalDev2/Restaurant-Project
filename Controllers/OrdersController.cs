...
namespace FinalProject.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [HttpGet("GetMealNameById/{orderId:int}")]
        public async Task<IActionResult> GetMealNameById(int orderId)
        {
        ...
        [HttpDelete("DeleteCashier/{cashierId}")]

        public async Task<IActionResult>  DeleteCashier(int cashierId)
        {
